...
export const getBookingTypeForTime = (
  time: string,
  isDinnerDay: boolean,
  currentDayOfWeek: DayOfWeek,
  selectedDate: Date,
  ...
  // Create time slots for each booking type using the same logic as createTimeOptionsFromOpeningHours
  const timeSlotsByType = {
    [BookingType.BRUNCH]: createTimeOptionsFromOpeningHours({
      bookingType: BookingType.BRUNCH,
      isDinnerDay,
      currentDayOfWeek,
      selectedDate,
      settings,
    }),
    [BookingType.LUNCH]: createTimeOptionsFromOpeningHours({
      bookingType: BookingType.LUNCH,
      isDinnerDay,
      currentDayOfWeek,
      selectedDate,
      settings,
    }),
    [BookingType.APERO]: createTimeOptionsFromOpeningHours({
      bookingType: BookingType.APERO,
      isDinnerDay,
      currentDayOfWeek,
      selectedDate,
      settings,
    ...
    ...(isDinnerDay
      ? {
          [BookingType.DINNER]: createTimeOptionsFromOpeningHours({
            bookingType: BookingType.DINNER,
            isDinnerDay,
            currentDayOfWeek,
            selectedDate,
            settings,
  ...
  // Find which booking type contains our time
  for (const [type, slots] of Object.entries(timeSlotsByType)) {
